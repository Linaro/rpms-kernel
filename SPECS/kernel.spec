...
# 
%changelog
* Fri Jul 17 2015 Jim Perrin <jperrin@centos.org> 4.1.0-0.rc2.git0.1.centos
- remove kdbus patches, revert patch to move everything into /usr
